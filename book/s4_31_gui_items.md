...
入口 = OnReload[2]→populate sub_1418AC420 (13 窗件), Update @40[9] 门 →
...
| 类 | 主 vt（1.19.3） | 次表 | 备注 |
|---|---|---|---|
| CWarOverView | 0x142A12C98 | @40 / @64 | populate sub_1418AC420 / OnReload 0x1418ABD10 |
...
| CGarrisonLogView | 0x142A00678 | @40 / @48 | s4_16 已载域 |
...
| COrganisationListWindow | 0x142A56348（4） | @40 0x142A56370（2） | — | [2] OnReload 0x141C3C7A0 |
...
| COrganisationDetailWindow | 0x142A93CA0（4） | @40 0x142A93CC8（2） | 14472（内嵌于 ListItem+144） | [2] OnReload 0x141F1EB10；源断言 industrial_org_detail_window.cpp:225 两版同行 |
...
| 舰史行 (=授勋行) | 槽[13]/[14] | ship+2264 CUnitHistory ✓; 条目+112 awardable/+80 日期 | **+114/+120 本行不消费** (沉船归因归 §4.16.15) | — | 定案 |
